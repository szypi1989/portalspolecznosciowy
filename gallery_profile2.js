...
if($("#form_id_login").val()==$("#form_id_profile").val()){
    ...
    alert("Pole zmiany opisu jest puste");    
        ...
        alert("Opis nie może przekraczać 200 znaków");    
        }
    }
}
});
...
$.get("get_comment.php?field=get_comments_html&id_user="+encodeURIComponent($("#form_id_login").val())+"&id_photo=" + encodeURIComponent(id)+"&id_profile="+encodeURIComponent($("#form_id_profile").val()), function(data){    
...
//funkcja init_clicked musi być na końcu!!!!,ze względu na to że daje akcje przyciską różnych funkcji
//powód:gdyby funkcja była przed inną funkcją nie zainicjowała by funkcji które nie zostały jeszcze odpalone
