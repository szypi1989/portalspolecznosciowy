        ...
        if (!$sessionmade) {
            ...
            $result=NULL;                
                    ...
                    @mysql_free_result($gosqls);
                        ...
                        $head_build->create_data('head_build_friends_profile',$session->get_session_user(),$result);
                        ...
                        echo '</div>';
                        if(!empty($result)){  
                        $profile_build= new friends_build($session->get_session_user(),$result);  
                        }else{
