...
class head_build_friends_profile{
    
    function head_build_friends_profile($id_login=null,$id_profile=null){
    ...
    echo '<head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="friends_profile.css" />
