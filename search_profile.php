        ...
        if (!$sessionmade) {
            ...
            $result=NULL;
                    ...
                    @mysql_free_result($gosqls);
                        ...
                        $head_build->create_data('head_build_search_profile',$session->get_session_user(),$result);
                        ...
                        echo '</div>';
                        if(!empty($result)){  
                        $profile_build= new search_build($session->get_session_user(),$result,$_GET['searchin']);  
                        }else{
                    ...
                    if(empty($_GET['searchin'])){
                    $query=NULL;
                    }else{
                    $query="&searchin=".$_GET['searchin'];   
                    }
                    Header("HTTP/1.1");
                    Header("Location:".$pathInfo['filename'].'.php?surname='.$row['name'].'.'.$row['surname'].'.'.$i.$query);                   
                    }        
        }
        ?>
    </body>
