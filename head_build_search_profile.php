...
class head_build_search_profile{
    
    function head_build_search_profile($id_login=null,$id_profile=null){
    ...
    echo '<head>
        ...
        <script type="text/javascript" src="search_profile.js"></script>
        <script type="text/javascript" src="jquery.naturalWidth.js"></script>
        <script type="text/javascript" src="friends_profile.js"></script>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="search_profile.css" />';
