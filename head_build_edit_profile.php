...
class head_build_edit_profile{
    var $avatar_image;
    var $content_image;
    
    function head_build_edit_profile($id_login=null,$id_profile=null){
    ...
    echo '<head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="edit_profile.css" />
