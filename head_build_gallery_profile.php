...
class head_build_gallery_profile{
    
    function head_build_gallery_profile($id_login=null,$id_profile=null){
    ...
    echo '<head>
        ...
        <script type="text/javascript" src="gallery_profile.js"></script>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="gallery_profile.css" />
        <link rel="stylesheet" type="text/css" media="screen" href="gallery_view.css" />
