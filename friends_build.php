...
class friends_build{
    ...
    function friends_build($id_login,$id_profile){
        $grant_all=($id_login==$id_profile)?true:false;
        $pathInfo = pathinfo(__FILE__);
        $sql="SELECT user_id,id_friends FROM friends WHERE user_id=".$id_profile;
        ...
        $building_href=NULL;
        $delete_option=($grant_all)?'<div class="delete_friend"><span>X</span></div>':NULL;
        ...
        echo '<div id="centertop"><div id="cont_friends"><div id="header"><div><span class="header" id="text_header"><b>Znajomi</b></span><span>(</span><span id="num_rows_friends" class="header">'.$num_rows_friends.'</span><span>)</span></div></div>
