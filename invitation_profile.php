...
<html>
        ...
        $config_session_handel = array(
            ...
            "redirection_vars" => array("message_control" => "reset")
        );    
        ...
        if (!$sessionmade) {
            ...
            $result=NULL;
                    ...
                    @mysql_free_result($gosqls);
                        ...
                        $head_build->create_data('head_build_invitation_profile',$session->get_session_user(),$result);
                        ...
                        echo '</div>';
                        if(!empty($result)){  
                        $profile_build= new invitation_build($session->get_session_user(),$result);  
                        }else{
