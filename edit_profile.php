        ...
        if (!$sessionmade) {
            ...
            $result=NULL;
                    ...
                    @mysql_free_result($gosqls);
                        ...
                        $head_build->create_data('head_build_edit_profile',$session->get_session_user(),$result);
                        ...
                        echo '</div>';
                        if(!empty($result)){  
                        $profile_build= new form_edit_profile($session->get_session_user(),$result);  
                        }else{
                        Header("HTTP/1.1");
                        Header("Location:".$pathInfo['filename'].'.php');   
                        }
                        echo "</div></div>";
