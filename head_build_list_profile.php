...
class head_build_list_profile{
    
    function head_build_list_profile($id_login=null,$id_profile=null){
    ...
    echo '<head>
        ...
        <script type="text/javascript" src="list_profile.js"></script>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="list_profile.css" />
